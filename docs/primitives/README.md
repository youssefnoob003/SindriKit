...
Foundation layer for SindriKit. Loaders, injection, and planned domains (evasion) rely on injected OS API tables and execution bridges documented here.
...
| [thread/](thread/README.md) | `snd_thread_win`, `snd_thread_nt`, `snd_thread_sys` (queue APC, resume, suspend) |
...
- [thread/](thread/README.md) — APC queue, resume, suspend (injection consumer)

...
;
; Invokes a syscall with up to 10 arguments safely. Handles both native x86
...
snd_invoke_syscall_asm PROC
    ...
    ; Push 10 arguments from the struct in reverse order
    push [ecx+40] ; arg10
    push [ecx+36] ; arg9
    push [ecx+32] ; arg8
    push [ecx+28] ; arg7
...
cleanup:
    ; Clean up 40 bytes of pushed args
    add esp, 40

...
typedef enum _SND_STATUS_CODE {
    ...
    SND_STATUS_INVALID_PARAMETER = -7,
    ...
    SND_STATUS_COFF_SECTION_NOT_FOUND,
    SND_STATUS_COFF_SYMBOL_NOT_FOUND,
    ...
    SND_STATUS_COFF_RELOCATION_UNSUPPORTED,
    SND_STATUS_COFF_SYMBOL_RESOLUTION_FAILED,
    SND_STATUS_COFF_ENTRY_NOT_RWX,
    SND_STATUS_COFF_ENTRY_UNMAPPED,
    SND_STATUS_COFF_NAKED_SYMB_REJECTED,

 ...
 * @retval SND_STATUS_NULL_POINTER If an argument is NULL or the output
 * buffer size is zero.
 * @retval SND_STATUS_SYMBOL_ENTRY_MISSING If the symbol name is unavailable.
 */
 ...
 * @retval SND_STATUS_NULL_POINTER If an argument is NULL or the output
 * buffer size is zero.
 * @retval SND_STATUS_SECTION_HEADER_MISSING If the section name is unavailable.
 */
 ...
 * @retval Pointer to the requested data.
 * @retval NULL If the range is outside the source buffer.
 */
